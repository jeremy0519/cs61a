...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    tenth_digit_opponent = (opponent_score % 100 - opponent_score % 10) // 10
    ones_digit_player = player_score % 10
    return max(1, 3 * abs(tenth_digit_opponent - ones_digit_player))
    # END PROBLEM 2
...
def num_factors(n):
    ...
    maximum = int(sqrt(n))
    isSquare = maximum**2 == n
    num = 0
    for i in range(1, maximum + 1):
        num += n % i == 0
    return 2 * num - isSquare
    # END PROBLEM 4
...
def make_averaged(original_function, times_called=1000):
    ...
    def ans(*args):
        ...
        for _ in range(times_called):
            a += original_function(*args)
        return a / times_called
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    "*** YOUR CODE HERE ***"
    score = -float("inf")
    for numRoll in range(1, 11):
        now = make_averaged(roll_dice, times_called)(numRoll, dice)
        if now > score:
            ans = numRoll
            score = now
    return ans
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 10
    return (
        0 if boar_brawl(score, opponent_score) >= threshold else num_rolls
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    return (
        0 if sus_update(0, score, opponent_score) >= score + threshold else num_rolls
    )  # Remove this line once implemented.
    # END PROBLEM 11
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    # return 6 # win rate 0.52

    # ans = 6
    # while sus_update(ans, score, opponent_score) + score >= GOAL and ans >= 1:
    #     ans -= 1
    # return ans # win rate 0.57

    # if sus_update(0, score, opponent_score) >= GOAL:
    #     return 0
    # return 6 # win rate 0.57
