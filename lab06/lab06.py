...
class Transaction:
    ...
    def report(self) -> str:
        ...
        if self.changed():
            "*** YOUR CODE HERE ***"
            msg = (
                "decreased " if self.before > self.after else "increased "
...
class BankAccount:
    ...
    def deposit(self, amount: int) -> int:
        ...
        self.transactions.append(
            Transaction(self.next_transaction_id, self.balance, self.balance + amount)
        )
    ...
    def withdraw(self, amount: int) -> int | str:
        ...
        if amount > self.balance:
            self.transactions.append(
                Transaction(self.next_transaction_id, self.balance, self.balance)
            )
            self.next_transaction_id += 1
...
class Mint:
    ...
    def create(self, coin: type[Coin]):
        "*** YOUR CODE HERE ***"
...
class VirFib:
    ...
    def __init__(self, value: int = 0):
        self.value = value
        self.previous: VirFib | None = None

    def next(self) -> VirFib:
        "*** YOUR CODE HERE ***"
        next = (
            VirFib(self.previous.value + self.value)
